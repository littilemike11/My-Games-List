        ...
        {/* <div className="hero bg-base-200 min-h-screen">
          <div className="hero-content border h-full flex-col lg:flex-row">
            ...
            <div>
              ...
              <p className="py-6">{game.summary}</p>
        ...
        <div className="flex flex-col lg:flex-row gap-8">
          ...
          {game.cover && (
            <div className="flex-shrink-0 w-full lg:w-1/3">
              ...
              />
              {/* Rating / Stats */}
              <div className="text-sm opacity-80 flex justify-around">
          ...
          <div className="flex-1 space-y-4">
            ...
            {/* {game.storyline && (
              <p className="text-md  leading-relaxed">{game.storyline}</p>
            )} */}
            <div className="flex space-x-6">
              <button className="btn btn-primary">Write a Review</button>
              <button className="btn btn-primary">Add to List</button>
              ...
              <div>
                ...
                <ul className="grid grid-cols-2 md:grid-cols-3 gap-4">
                  {game.similarGames.map((simGame) => (
                    <li
                      key={simGame.id}
                      className="bg-base-200 p-4 rounded-lg hover:bg-base-300 transition"
                    >
